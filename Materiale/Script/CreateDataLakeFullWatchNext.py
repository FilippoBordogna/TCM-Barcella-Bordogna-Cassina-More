...
##### FROM FILES
tedx_dataset_path = "s3://bucket-dati/tedx_dataset_complete.csv"
...
## READ TAGS DATASET
tags_dataset_path = "s3://bucket-dati/tags_dataset.csv"
tags_dataset = spark.read.option("header","true").csv(tags_dataset_path)

## READ WATCH NEXT DATASET
watch_next_dataset_path = "s3://bucket-dati/watch_next_dataset.csv"
...
wn=watch_next_dataset.join(tedx_dataset,tedx_dataset.idx == watch_next_dataset.watch_next_idx)
wn.printSchema()
watch_next_dataset_agg=wn.groupBy(col("id").alias("idx_ref_2")).agg(collect_list(struct("url","watch_next_idx","main_speaker","title","details","posted","num_views")).alias("watch_next"))
...
mongo_uri = "mongodb://tcm-shard-00-00.d0u9l.mongodb.net:27017,tcm-shard-00-01.d0u9l.mongodb.net:27017,tcm-shard-00-02.d0u9l.mongodb.net:27017"
